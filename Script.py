...
📌 ꜰᴏʀ ᴍᴏᴠɪᴇꜱ:  
➤ ᴍᴏᴠɪᴇ ɴᴀᴍᴇ + ʏᴇᴀʀ (ᴇx: ᴍᴀꜱᴛᴇʀ 2021)  
...
<blockquote expandable><b><i>ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜɪꜱ ꜰɪʟᴇ ᴛᴏ ꜱᴏᴍᴇᴡʜᴇʀᴇ ᴇʟꜱᴇ & ꜱᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ᴛʜᴇʀᴇ</i></b></blockquote>"""
    ...
    I_CUDNT = """<b>ɪ ᴄᴀɴ'ᴛ ꜱʀᴇᴀᴄʜ {} 😔

 ᴩʟᴇᴀꜱᴇ ᴄᴜʀʀᴇᴄᴛ ʏᴏᴜʀ ꜱᴩᴇʟʟɪɴɢ ɪɴ ɢᴏᴏɢʟᴇ
...
⭕ ಮುಂದುವರಿಯಲು ನೀವು ಕಡ್ಡಾಯವಾಗಿ ಅಗತ್ಯವಿರುವ ಚಾನೆಲ್‌ಗಳನ್ನು ಸೇರಿಕೊಳ್ಳಬೇಕು.
...
<blockquote>ᴍʏ ᴀᴅᴍɪɴ ʜᴀꜱ ᴛᴏʟᴅ ᴍᴇ ᴛᴏ ʟᴇᴀᴠᴇ ᴛʜɪꜱ ɢʀᴏᴜᴘ, ꜱᴏ ɪ ʜᴀᴠᴇ ᴛᴏ ɢᴏ ! ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴀᴅᴅ ᴍᴇ ᴀɢᴀɪɴ ᴄᴏɴᴛᴀᴄᴛ ꜱᴜᴘᴘᴏʀᴛ.</blockquote></b>"""
    ...
    SEARCHING_TXT = """<b><i> ꜱᴄᴀɴɴɪɴɢ ᴅʙ ꜰᴏʀ '{}' 🔎</i></b>"""
...
ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ᴍᴠ : <b><code>{}</code></b>"""
...
•─────•─────────•─────•
🏷️ <a href='https://t.me/+lUBQVJCP6MFmNjQ1'>ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ᴘʀᴏᴏꜰ</a>
