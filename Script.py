...
ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇǫᴜᴇꜱᴛ ᴀɢᴀɪɴ."""
    ...
    CUDNT_FND = """<b>ɪ ᴛʜɪɴᴋ ꜱᴩᴇʟʟɪɴɢ ᴍɪꜱᴛᴀᴋᴇ  ɪɴ ʏᴏᴜʀ ʀᴇqᴜᴇꜱᴛ❗\nʙᴜᴛ ᴅᴏɴ'ᴛ ᴡᴏʀʀʏ. 😊 ᴄʜᴏᴏꜱᴇ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ ɴᴀᴍᴇ ʙᴇʟᴏᴡ? 👇\n\n<blockquote>ನೀವು ತಪ್ಪಾದ ಪದವನ್ನು Type ಮಾಡ್ದಿದೀರಿ ದಯವಿತ್ತು ಕೆಳೆಗಿರುವ ಸರಿಯಾದ ಪದವನ್ನು ಕ್ಲಿಕ್ ಮಾಡಿ 👇</blockquote></b>"""
...
⚜️ ᴇxᴀᴍᴘʟᴇ : Master 2021 or Master 2021 Kannada 
...
3) ᴍᴏᴠɪᴇ ɪs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ ʀᴇᴘᴏʀᴛ ᴛᴏ ᴀᴅᴍɪɴs</b>"""
    ...
    MVE_NT_FND = """<b>ᴛʜɪꜱ ᴍᴏᴠɪᴇ ɴᴏᴛ ꜰᴏᴜɴᴅ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀꜱᴇ 😔\n\n<blockquote>ಈ ಮೂವಿ ನನ್ನ Database ಅಲ್ಲಿ ಲಭ್ಯವಿಲ್ಲ </blockquote></b>"""
...
➢ QR Cᴏᴅᴇ : <a href='{}'>𝐂𝐋𝐈𝐂𝐊 𝐇𝐄𝐑𝐄 𝐓𝐎 𝐒𝐂𝐀𝐍</a>
...
ᴡᴀɴᴛᴇᴅ ᴍᴏᴠɪᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b>📂𝐍𝐀𝐌𝐄{file_name}</a></b>\n\n×͜× 𝐉𝐎𝐈𝐍 𝐅𝐎𝐑 𝐌𝐎𝐑𝐄: @Filmy_Fusion01</b>"""
...
🏆 ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ɴᴇᴡ ᴘʟᴀɴ ᴀᴘᴀʀᴛ ꜰʀᴏᴍ ᴛʜᴇ ɢɪᴠᴇɴ ᴘʟᴀɴ, ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀʟᴋ ᴛᴏ ᴏᴜʀ <a href='https://t.me/Master_hp_raj'>ᴏᴡɴᴇʀ</a> ᴅɪʀᴇᴄᴛʟʏ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.
...
‼️ 𝑨𝒇𝒕𝒆𝒓 𝑺𝒆𝒏𝒅𝒊𝒏𝒈 𝑨 𝑺𝒄𝒓𝒆𝒆𝒏𝒔𝒉𝒐𝒕 𝑷𝒍𝒆𝒂𝒔𝒆 𝑮𝒊𝒗𝒆 𝒖𝒔 𝒔𝒐𝒎𝒆 𝑻𝒊𝒎𝒆 𝑻𝒐 𝑨𝒅𝒅 𝒀𝒐𝒖 𝑰𝒏 𝑻𝒉𝒆 𝑷𝒓𝒆𝒎𝒊𝒖𝒎 𝑳𝒊𝒔𝒕.</b>"""    
    ...
    SOURCE_TXT ="""<b>𝕊𝕠𝕦𝕣𝕔𝕖 ℂ𝕠𝕕𝕖: 👇 </b>

 ꜱᴏʀʀʏ ᴛʜɪꜱ ɪꜱ ᴄʟᴏꜱᴇᴅ ꜱᴏᴜʀᴄᴇ """
